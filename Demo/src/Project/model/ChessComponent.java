...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    private static final Color[] BACKGROUND_COLORS = {Color.white, Color.GRAY};
    /**
     * handle click event
     */
    ...
    protected ChessComponent(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor, ClickController clickController, int size , String chessType) {
    ...
    public void updateMoved(){this.moved = !this.moved ;}
